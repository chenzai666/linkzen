      ...
      <form className="max-w-2xl p-4" onSubmit={onSubmit}>
        <div className="items-center justify-start gap-4 md:flex">
          <FormSectionColumns title={t("Username")} required>
            ...
            {errors?.email && (
              <p className="p-1 text-[13px] text-red-600">{errors.email.message}</p>
            )}
          </FormSectionColumns>
          <FormSectionColumns title={t("Name")}>
            ...
            />
            {errors?.name && (
              <p className="p-1 text-[13px] text-red-600">{errors.name.message}</p>
            )}
          </FormSectionColumns>
        </div>
        <div className="items-center justify-start gap-4 md:flex">
          ...
          <FormSectionColumns title={t("Login Password")}>
            <Label className="sr-only" htmlFor="password">{t("Login Password")}</Label>
            <Input
              id="password"
              className="flex-1 shadow-inner"
              size={20}
            ...
            />
            {errors?.password && (
              <p className="p-1 text-[13px] text-red-600">{errors.password.message}</p>
            )}
          </FormSectionColumns>
        </div>
        <div className="items-center justify-start gap-4 md:flex">
          <FormSectionColumns title={t("Active")}>
            <div className="flex w-full items-center gap-2">
              <Label className="sr-only" htmlFor="active">{t("Active")}</Label>
              <Switch
                id="active"
                {...register("active")}
